...
import com.cp.suishouji.SettingActivity.LineButtonClickListener;
import com.cp.suishouji.adapter.PagerFragmentAdapter;
import com.cp.suishouji.fragment.AssistantFragment;
import com.cp.suishouji.fragment.RefreshableFragment;
...
public class AssistantActivity extends SherlockFragmentActivity implements OnClickListener, OnPageChangeListener {
...
//	}
	...
	protected void initActionbar() {
		...
		View inflate = getLayoutInflater().inflate(R.layout.actionbar_assistant, null);
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		...
		if(mPager.getCurrentItem()==0){
			((AssistantFragment)fragmentList.get(0)).refresh();
		}
	}
}
